...
namespace ReviewsSites.Migrations
{
    ...
    [Migration("20190308033509_NewSnakeVenomPhoto")]
    partial class NewSnakeVenomPhoto
    {
            ...
            modelBuilder.Entity("ReviewsSites.Models.Beer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { BeerId = 9, Abv = 67.5f, Brewery = "BrewMeister", CategoryId = 4, Description = "In certain countries, Brewmeister's Snake Venom beer isn't actually a beer because of hits insanely high ABV. This barley beer has an incredibly high proof that makes it rival, if not exceed, many liquors out there. At around $50 per bottle, this insanely powerful beer will burn a hole in your wallet - and possibly your throat.", ImgPath = "/Images/Snake-Venom.png", Name = "Snake Venom", Rating = 5f },
